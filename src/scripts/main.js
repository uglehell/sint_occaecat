...
window.addEventListener('scroll', () => {
  ...
  } if (pageYOffset > (innerHeight - innerHeight * .1) && pageYOffset < (innerHeight * 2 - innerHeight * .1)) {
    navigation.button.classList.add('nav-button--dark')
  } else {
    navigation.button.classList.remove('nav-button--dark')
  } if (pageYOffset < innerHeight * 3) {
    risquis.content.style.transform             = `translate(-50%, -50%) translateY(${-(pageYOffset - innerHeight) * .1}px)`
    risquis.illustration.third.style.transform  = `translate(-50%, -50%) translateY(${(pageYOffset - innerHeight) * .1}px)`
    risquis.illustration.second.style.transform = `translate(-50%, -50%) translateY(${(pageYOffset - innerHeight) * .05}px)`
